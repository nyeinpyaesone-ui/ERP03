...
async def require_permission(
    ...
    *,
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="Invalid authorization claims") from exc
...
def permission_dependency(permission_code: str):
    async def dependency(
        ...
        await require_permission(permission_code, claims=claims, session=session)
        return claims
