...
- Root `backend/README.md` identifies the active backend as ERP erp03 System v2.2 and describes FastAPI + SQLAlchemy + PostgreSQL, Alembic migrations, Redis, Ollama, WebSockets, workflows, integrations, and RBAC.
