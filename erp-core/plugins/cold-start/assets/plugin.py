...
class Plugin(ERPPlugin):
    ...
    def description(self) -> str:
        return "Assets module for ERP-Core"
    ...
    def register_routes(self, app: FastAPI, prefix: str = "/api/v1") -> None:
        """Register FastAPI routes for assets."""
        router = APIRouter(prefix=prefix, tags=["Assets"])
        
        @router.get("/")
        async def list_items():
            return {"message": "Assets API", "status": "active"}
    ...
    def register_models(self) -> List:
        """Return SQLAlchemy models for assets."""
        # Define models here
        # Example:
        # class Order(Base):
        #     __tablename__ = "assets_orders"
